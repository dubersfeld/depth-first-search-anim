...
All newly discovered vertices are colored in green. When the search is completed all vertices are blue and the edges that connect a vertex to its parent are blue.<br/>
